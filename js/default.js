            ...
            **/
            rePosition : function(quick, force){
                ...
                if( settings.lockBottom )
                    maxTopPos = $obj[0].parentNode.clientHeight - objHeight - settings.offsetBottom; // get the maximum top position of the floated element inside its parent
                ...
                objFartherThanTopPos    = $obj.offset().top > (settings.startOffset + settings.offsetY);    // check if the object is at its top position (starting point)
